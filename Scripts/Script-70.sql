SELECT 
    x.OPERATIONCODE,
    SUM(vps.INITIALUSERPRIMARYQUANTITY) AS TOTAL_QTY
FROM
...
LEFT OUTER JOIN (
    ...
    ORDER BY 
        GROUPSTEPNUMBER ASC
) vps ON vps.PRODUCTIONORDERCODE = x.PRODUCTIONORDERCODE
WHERE
    ...
    AND TIMESTAMP(TRIM(x.PROGRESSSTARTPROCESSDATE), TRIM(x.PROGRESSSTARTPROCESSTIME)) BETWEEN '2024-07-30 07:00:00' AND '2024-07-30 15:00:00'
    AND x.INACTIVE = 1
GROUP BY 
    x.OPERATIONCODE