...
FROM (SELECT DISTINCT 
			...
			a4.VALUEDECIMAL AS QTYSENDFISRT
		FROM 
			PRODUCTIONDEMAND p 
		...
		LEFT JOIN ADSTORAGE a4 ON a4.UNIQUEID = p.ABSUNIQUEID AND a4.FIELDNAME = 'QtySendFisrt'
		WHERE 
			p.SUBCODE01 = 'CX' 
			AND p.SUBCODE02 = 'R22' 
			AND p.SUBCODE03 = '13455'
			AND p.SUBCODE04 = 'D02' 
			AND p.ORIGDLVSALORDLINESALORDERCODE = 'EXP2500175'
...
SELECT TGLRENCANA, (QTYSENDFISRT) FROM ITXVIEW_RAJUT p WHERE 
			p.SUBCODE01 = 'CX' 
			AND p.SUBCODE02 = 'R22' 
			AND p.SUBCODE03 = '13455'
			AND p.SUBCODE04 = 'D02' 
