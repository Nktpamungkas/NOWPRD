...
SELECT
    ...
    CASE WHEN dept.LONGDESCRIPTION IS NULL THEN '-' ELSE dept.LONGDESCRIPTION END|| CASE WHEN a10.VALUESTRING IS NULL THEN '-' ELSE a10.VALUESTRING END AS DESC_DEMAND,
...
--WHERE
--    	PRODUCTIONDEMANDSTEP.PRODUCTIONORDERCODE = '00120319';
