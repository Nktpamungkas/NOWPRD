...
LEFT JOIN ADSTORAGE a46 ON a46.UNIQUEID = PRODUCTIONDEMAND.ABSUNIQUEID AND a46.FIELDNAME = 'DefectTypeCode'
LEFT JOIN USERGENERICGROUP u3 ON u3.CODE = a46.VALUESTRING AND u3.USERGENERICGROUPTYPECODE = '006'
--WHERE
--    	PRODUCTIONDEMANDSTEP.PRODUCTIONORDERCODE = '00154526';
