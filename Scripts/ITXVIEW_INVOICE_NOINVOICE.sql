        ...
        CASE
            ...
            CASE
                    ...
                    CASE
                        ...
                        ELSE round((ITXVIEW_FOC_INVOICE2.QUANTITY_FOC), 2)
                    END AS HARGA_FOC,
        	...
        	0
                ...
                LEFT JOIN SALESDOCUMENT SALESDOCUMENT ON PLANTINVOICE.CODE = SALESDOCUMENT.PROVISIONALCODE
                ...
                LEFT JOIN SALESDOCUMENTLINE SALESDOCUMENTLINE ON SALESDOCUMENTLINE.SALESDOCUMENTPROVISIONALCODE = SALESDOCUMENT.PROVISIONALCODE
                ...
                LEFT JOIN ITXVIEW_FOC_INVOICE2 ITXVIEW_FOC_INVOICE2 ON
                    ...
                    --                                        WHERE PLANTINVOICE.CODE= 'DMU23070600'
                                WHERE
                                    PLANTINVOICE.CODE IN ('EX23070050')
