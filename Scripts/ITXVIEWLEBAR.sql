...
LEFT JOIN ADSTORAGE a  ON a.UNIQUEID = p.ABSUNIQUEID AND a.NAMENAME = 'Width'
...
LEFT JOIN ADSTORAGE a2 ON a2.UNIQUEID = p2.ABSUNIQUEID AND a2.NAMENAME = 'Width'
WHERE s.SALESORDERCODE = 'OPN2500373' AND s.ORDERLINE = 150