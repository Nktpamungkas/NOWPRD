...
SELECT
    ...
    CASE
    	WHEN CAST(p.CREATIONDATETIME AS DATE) >= '2025-02-07' THEN
    		CASE
		        WHEN DAYOFWEEK_ISO(a6.VALUEDATE) = 1 THEN SUBSTR(a6.VALUEDATE + 2 DAYS, 1, 10) -- SENIN s/d RABU
		        WHEN DAYOFWEEK_ISO(a6.VALUEDATE) = 2 THEN SUBSTR(a6.VALUEDATE + 2 DAYS, 1, 10) -- SELASA s/d KAMIS
		        WHEN DAYOFWEEK_ISO(a6.VALUEDATE) = 3 THEN SUBSTR(a6.VALUEDATE + 2 DAYS, 1, 10) -- RABU s/d JUMAT
		        WHEN DAYOFWEEK_ISO(a6.VALUEDATE) = 4 THEN SUBSTR(a6.VALUEDATE + 4 DAYS, 1, 10) -- KAMIS s/d SENIN
		        WHEN DAYOFWEEK_ISO(a6.VALUEDATE) = 5 THEN SUBSTR(a6.VALUEDATE + 4 DAYS, 1, 10) -- JUMAT s/d SELASA
		    END
		ELSE 
			CASE
		        WHEN DAYOFWEEK_ISO(a6.VALUEDATE) = 1 THEN SUBSTR(a6.VALUEDATE + 3 DAYS, 1, 10) -- SENIN s/d KAMIS
		        WHEN DAYOFWEEK_ISO(a6.VALUEDATE) = 2 THEN SUBSTR(a6.VALUEDATE + 3 DAYS, 1, 10) -- SELASA s/d JUMAT
		        WHEN DAYOFWEEK_ISO(a6.VALUEDATE) = 3 THEN SUBSTR(a6.VALUEDATE + 5 DAYS, 1, 10) -- RABU s/d SENIN
		        WHEN DAYOFWEEK_ISO(a6.VALUEDATE) = 4 THEN SUBSTR(a6.VALUEDATE + 5 DAYS, 1, 10) -- KAMIS s/d SELASA
		        WHEN DAYOFWEEK_ISO(a6.VALUEDATE) = 5 THEN SUBSTR(a6.VALUEDATE + 5 DAYS, 1, 10) -- JUMAT s/d RABU
		    END
    END AS TGL_TARGET,
