SELECT
    ...
    CASE
        WHEN ITXVIEWRESEP.RECIPETYPE = '1' THEN CAST( ((ITXVIEWRESEP.PICKUPPERCENTAGE/100 * 42.7) + ITXVIEWRESEP.RESIDUALBATHVOLUME) * ITXVIEWRESEP2.CONSUMPTION AS DECIMAL(18, 7))
        ELSE 
            CASE
                WHEN ITXVIEWRESEP2.CONSUMPTIONTYPE = '1' THEN CAST( ((42.7 * VIEWPRODUCTIONRESERVATION.PICKUPQUANTITY) * ITXVIEWRESEP2.CONSUMPTION) / 1000 AS DECIMAL(18, 7))
                WHEN ITXVIEWRESEP2.CONSUMPTIONTYPE = '2' THEN CAST( ((42.7 * (ITXVIEWRESEP2.CONSUMPTION/100)) * 1000) / 1000 AS DECIMAL(18, 7))
            END
    END AS QTY,
    CASE 
...
WHERE 
    VIEWPRODUCTIONRESERVATION.PRODUCTIONORDERCODE = '00234379'
    AND VIEWPRODUCTIONRESERVATION.GROUPLINE IN ('406') 
ORDER BY
