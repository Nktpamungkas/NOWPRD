...
SELECT
    ...
    a49.VALUESTRING AS NOTE_TAS_KGF
FROM
...
LEFT JOIN ADADDITIONALDATA ad2 ON ad2.NAME = a48.FIELDNAME
...
LEFT JOIN ADSTORAGE a49 ON a49.UNIQUEID = p2.ABSUNIQUEID AND a49.FIELDNAME = 'NoteTas'
WHERE
	PRODUCTIONDEMANDSTEP.PRODUCTIONORDERCODE = '00187730';
