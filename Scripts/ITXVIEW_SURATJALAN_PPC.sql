...
LEFT OUTER JOIN DB2ADMIN.CUSTOMERSUPPLIERDATA CUSTOMERSUPPLIERDATA ON BUSINESSPARTNER.NUMBERID = CUSTOMERSUPPLIERDATA.BUSINESSPARTNERNUMBERID
LEFT OUTER JOIN DB2ADMIN.ALLOCATION ALLOCATION ON CUSTOMERSUPPLIERDATA.CODE = ALLOCATION.CUSTOMERCODE
RIGHT OUTER JOIN DB2ADMIN.WRKDOCUMENTPRINT WRKDOCUMENTPRINT ON ALLOCATION.ORDERCODE = WRKDOCUMENTPRINT.SALESDOCUMENTPROVISIONALCODE
RIGHT OUTER JOIN DB2ADMIN.SALESDOCUMENT SALESDOCUMENT ON WRKDOCUMENTPRINT.SALESDOCUMENTPROVISIONALCODE = SALESDOCUMENT.PROVISIONALCODE
LEFT OUTER JOIN DB2ADMIN.SALESDOCUMENTLINE SALESDOCUMENTLINE ON ALLOCATION.ORDERCODE = SALESDOCUMENTLINE.SALESDOCUMENTPROVISIONALCODE
...
WHERE
    ALLOCATION.ORIGINTRNTRANSACTIONNUMBER IS NULL
        AND SALESDOCUMENT.PROVISIONALCODE = 'POD2305257'
