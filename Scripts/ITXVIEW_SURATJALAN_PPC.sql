...
LEFT JOIN CUSTOMERSUPPLIERDATA CUSTOMERSUPPLIERDATA ON BUSINESSPARTNER.NUMBERID = CUSTOMERSUPPLIERDATA.BUSINESSPARTNERNUMBERID
LEFT JOIN ALLOCATION ALLOCATION ON CUSTOMERSUPPLIERDATA.CODE = ALLOCATION.CUSTOMERCODE
RIGHT JOIN WRKDOCUMENTPRINT WRKDOCUMENTPRINT ON ALLOCATION.ORDERCODE = WRKDOCUMENTPRINT.SALESDOCUMENTPROVISIONALCODE
RIGHT JOIN SALESDOCUMENT SALESDOCUMENT ON WRKDOCUMENTPRINT.SALESDOCUMENTPROVISIONALCODE = SALESDOCUMENT.PROVISIONALCODE
...
--        AND SALESDOCUMENT.PROVISIONALCODE = 'DRP2300693'
