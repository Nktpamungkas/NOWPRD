...
LEFT JOIN ORDERPARTNER ORDERPARTNER ON SALESDOCUMENT.COMPANYCODE = ORDERPARTNER.CUSTOMERSUPPLIERCOMPANYCODE AND SALESDOCUMENT.ORDERTYPE = ORDERPARTNER.CUSTOMERSUPPLIERTYPE 
...
LEFT JOIN ORDERPARTNERBRAND ORDERPARTNERBRAND ON SALESDOCUMENT.ORDERPARTNERBRANDCODE = ORDERPARTNERBRAND.CODE
...
--        SALESDOCUMENT.PROVISIONALCODE = 'ESP2400513'
        AND SALESDOCUMENTLINE.DLVSALORDERLINESALESORDERCODE = 'DOM2401017'
