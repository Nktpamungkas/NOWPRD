SELECT DISTINCT
    ...
    CASE
        WHEN TRIM(i.DEFINITIVECOUNTERCODE) = 'CESDEF' OR TRIM(i.DEFINITIVECOUNTERCODE) = 'CESPROV' OR
	        ...
	        TRIM(i.DEFINITIVECOUNTERCODE) = 'EXDPROV' OR TRIM(i.DEFINITIVECOUNTERCODE) = 'EXPDEF' OR
	        TRIM(i.DEFINITIVECOUNTERCODE) = 'EXPPROV' OR TRIM(i.DEFINITIVECOUNTERCODE) = 'GSEDEF' OR 
	        TRIM(i.DEFINITIVECOUNTERCODE) = 'GSEPROV' OR TRIM(i.DEFINITIVECOUNTERCODE) = 'PSEPROV' THEN '' ELSE 
...
WHERE 
    i.DLVSALORDERLINESALESORDERCODE = 'EXP2400168' 
...
WHERE 
    ...
    AND PROVISIONALCODE = 'ESP2400510'
GROUP BY 
    KET_YARDMETER
...
WHERE 
    i.DLVSALORDERLINESALESORDERCODE = 'EXP2400279' 
