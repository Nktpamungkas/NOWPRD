...
--    i.GOODSISSUEDATE = '2024-03-23'
--    AND 
    PROVISIONALCODE = 'PED2400125'
...
WHERE 
    ise.PROVISIONALCODE = 'PED2400125' AND ise.ITEMTYPEAFICODE = 'KFF'
GROUP BY 
    ise.ITEMTYPEAFICODE,
    inpe.PROJECT,
    ise.ADDRESSEE,
...
SELECT * FROM ITXVIEW_SURATJALAN_EXIM2A WHERE PROVISIONALCODE = 'GSP2400004'

SELECT * FROM ITXVIEW_NO_PROJECTS_EXIM WHERE PROVISIONALCODE = 'GSP2400004'
