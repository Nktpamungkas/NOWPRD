...
SELECT DISTINCT * FROM (SELECT  
    ...
    CAST(LPAD(MONTH(p3.STARTDATE - a2.VALUETIMESTAMP), 2, '0') + LPAD(MONTH(CURRENT_TIMESTAMP - p3.STARTDATE), 2, '0') AS INTEGER) AS TOTAL_DURASI_BULAN,
    CAST(LPAD(DAY(p3.STARTDATE - a2.VALUETIMESTAMP), 2, '0') + LPAD(DAY(CURRENT_TIMESTAMP - p3.STARTDATE), 2, '0') AS INTEGER) AS TOTAL_DURASI_HARI,
    CAST(LPAD(HOUR(p3.STARTDATE - a2.VALUETIMESTAMP), 2, '0') + LPAD(HOUR(CURRENT_TIMESTAMP - p3.STARTDATE), 2, '0') AS INTEGER) AS TOTAL_DURASI_JAM,
    CAST(LPAD(MINUTE(p3.STARTDATE - a2.VALUETIMESTAMP), 2, '0') + LPAD(MINUTE(CURRENT_TIMESTAMP - p3.STARTDATE), 2, '0') AS INTEGER) AS TOTAL_DURASI_MENIT,
