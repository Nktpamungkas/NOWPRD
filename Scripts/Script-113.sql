...
LEFT OUTER JOIN (
		...
		LEFT JOIN PRODUCT ON
			PRODUCT.ITEMTYPECODE = p.ITEMTYPEAFICODE
		...
		LEFT OUTER JOIN USERGENERICGROUP f ON
			p.SUBCODE05 = f.CODE
			AND f.USERGENERICGROUPTYPECODE = 'CL1'
		LEFT OUTER JOIN PRODUCTIONDEMAND h ON
...
WHERE
	(
		x.OPERATIONCODE IN (
			'BAT2', 'BKN1', 'BEL1', 'BAT3', 'BBS1', 'JHP1', 'WAIT36'
		)
	)
	...
	) BETWEEN '2024-10-30 07:00:00' AND '2024-10-30 15:00:00'
	AND x.INACTIVE = 1
	AND x.PRODUCTIONORDERCODE ='00175991'
GROUP BY
	x.OPERATIONCODE,
