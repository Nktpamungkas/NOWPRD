...
FROM
    (
		...
		LEFT JOIN USERGENERICGROUP u2 ON u2.CODE = SALESORDERLINE.SUBCODE05 AND u2.USERGENERICGROUPTYPECODE = 'CL1'
		LEFT JOIN ADSTORAGE a42 ON a42.UNIQUEID = u2.ABSUNIQUEID AND a42.FIELDNAME = 'ColorGroupCode'
        WHERE
--                    	SALESORDER.CODE = 'DOM2401456' AND 
