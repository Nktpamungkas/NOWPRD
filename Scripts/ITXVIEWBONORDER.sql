...
FROM
    (
        ...
        LEFT JOIN ADSTORAGE a43 ON a43.UNIQUEID = SALESORDERLINE.ABSUNIQUEID AND a43.FIELDNAME = 'cocokwarna'
        LEFT JOIN ADADDITIONALDATA a ON a.NAME = a43.FIELDNAME 
        LEFT JOIN ADSTORAGE a44 ON a44.UNIQUEID = SALESORDERLINE.ABSUNIQUEID AND a44.FIELDNAME = 'Colorist'
        LEFT JOIN ADADDITIONALDATA a2 ON a2.NAME = a44.FIELDNAME 
        WHERE
--        	SALESORDER.CODE = 'REP2400548' AND 
