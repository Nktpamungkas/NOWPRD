...
FROM
	(SELECT 
		...
		LISTAGG(CASE
					WHEN p3.ITEMTYPEAFICODE = 'DYR' OR p3.ITEMTYPEAFICODE = 'GYR' THEN TRIM(f.SUMMARIZEDDESCRIPTION)
...
--							NOT p4.ITEMTYPECODE = 'KFF' AND
	...
	LEFT JOIN FULLITEMKEYDECODER f ON f.ITEMTYPECODE = p3.ITEMTYPEAFICODE AND 
								f.SUBCODE01 = p3.SUBCODE01 AND f.SUBCODE02 = p3.SUBCODE02 AND
								f.SUBCODE03 = p3.SUBCODE03 AND f.SUBCODE04 = p3.SUBCODE04 AND
								f.SUBCODE05 = p3.SUBCODE05 AND f.SUBCODE06 = p3.SUBCODE06 AND
								f.SUBCODE07 = p3.SUBCODE07 AND f.SUBCODE07 = p3.SUBCODE07 AND 
