...
--    ALLOCATION.DECOSUBCODE06,
    ...
    CASE
        WHEN a.VALUESTRING IS NOT NULL THEN CAST(a.VALUESTRING AS char(100))
        ELSE CAST(SALESDOCUMENTLINE.DLVSALESORDERLINEORDERLINE AS char(100))
...
--        AND SALESDOCUMENT.PROVISIONALCODE = 'PSM2500156'
