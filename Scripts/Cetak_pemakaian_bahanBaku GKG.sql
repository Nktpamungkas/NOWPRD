...
--    AND TIMESTAMP(TRIM(x.PROGRESSSTARTPROCESSDATE), TRIM(x.PROGRESSSTARTPROCESSTIME)) BETWEEN '2024-07-09 23:00:00' AND '2024-07-10 23:00:00'
    AND x.PRODUCTIONORDERCODE = '00153079'
GROUP BY 
    x.PRODUCTIONORDERCODE,
    x.OPERATIONCODE, 
    x.OPERATORCODE,
