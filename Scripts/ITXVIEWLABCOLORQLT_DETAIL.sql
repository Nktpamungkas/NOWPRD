...
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABNCHLOR_QTY ON QUALITYDOCLINE_LABNCHLOR_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABNCHLOR_QTY.CHARACTERISTICCODE = 'LABNCHLOR'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABCSSTN_QTY ON QUALITYDOCLINE_LABCSSTN_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABCSSTN_QTY.CHARACTERISTICCODE = 'LABCSSTN'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABCLRSWHA_QTY ON QUALITYDOCLINE_LABCLRSWHA_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABCLRSWHA_QTY.CHARACTERISTICCODE = 'LABCLRSWHA'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABCLRSWHC_QTY ON QUALITYDOCLINE_LABCLRSWHC_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABCLRSWHC_QTY.CHARACTERISTICCODE = 'LABCLRSWHC'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABCLRSWHW_QTY ON QUALITYDOCLINE_LABCLRSWHW_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABCLRSWHW_QTY.CHARACTERISTICCODE = 'LABCLRSWHW'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABCLRSWRA_QTY ON QUALITYDOCLINE_LABCLRSWRA_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABCLRSWRA_QTY.CHARACTERISTICCODE = 'LABCLRSWRA'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABCLRSWRC_QTY ON QUALITYDOCLINE_LABCLRSWRC_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABCLRSWRC_QTY.CHARACTERISTICCODE = 'LABCLRSWRC'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABCLRSWRW_QTY ON QUALITYDOCLINE_LABCLRSWRW_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABCLRSWRW_QTY.CHARACTERISTICCODE = 'LABCLRSWRW'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABCLRPRT_QTY ON QUALITYDOCLINE_LABCLRPRT_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABCLRPRT_QTY.CHARACTERISTICCODE = 'LABCLRPRT'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABCLRPRC_QTY ON QUALITYDOCLINE_LABCLRPRC_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABCLRPRC_QTY.CHARACTERISTICCODE = 'LABCLRPRC'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABCLRPRW_QTY ON QUALITYDOCLINE_LABCLRPRW_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABCLRPRW_QTY.CHARACTERISTICCODE = 'LABCLRPRW'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABBLEEDR_QTY ON QUALITYDOCLINE_LABBLEEDR_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABBLEEDR_QTY.CHARACTERISTICCODE = 'LABBLEEDR'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABBLEEDW_QTY ON QUALITYDOCLINE_LABBLEEDW_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABBLEEDW_QTY.CHARACTERISTICCODE = 'LABBLEEDW'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABAAW_QTY ON QUALITYDOCLINE_LABAAW_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABAAW_QTY.CHARACTERISTICCODE = 'LABAAW'
LEFT JOIN QUALITYDOCLINE QUALITYDOCLINE_LABSALIVA_QTY ON QUALITYDOCLINE_LABSALIVA_QTY.QUALITYDOCUMENTHEADERLINE = QUALITYDOCUMENT.HEADERLINE AND QUALITYDOCLINE_LABSALIVA_QTY.CHARACTERISTICCODE = 'LABSALIVA'
WHERE
    QUALITYDOCLINE_LABCOLOUR.QUALITYDOCUMENTHEADERCODE = 'LABDIP'
--        AND QUALITYDOCUMENT.LOTCODE LIKE '%LAB2500025%';